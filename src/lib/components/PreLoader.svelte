<script lang="ts">
	...
	const gltf = suspend(
		useGltf('/models/arcadeRoomCompressed.glb', {
			useDraco: true,
		})
	)
	...
	const textureProjectsSingle = load({
		...
		'/pictures/projects/ARthlete/1.png':
			'/pictures/projects/ARthlete/1.png',
		...
		'/pictures/projects/SinOfSloth/2.png':
			'/pictures/projects/SinOfSloth/2.png',
		'/pictures/projects/SlimeHero/1.png':
			'/pictures/projects/SlimeHero/1.png',
		'/pictures/projects/SlimeHero/2.png':
			'/pictures/projects/SlimeHero/2.png',
		'/pictures/projects/SlimeHero/3.png':
			'/pictures/projects/SlimeHero/3.png',
